...
// RegisterModel register models
func RegisterModelNew(models ...interface{}) {
	RegisterModelWithPrefixNew("", models...)
}

// RegisterModelWithPrefix register models with a prefix
func RegisterModelWithPrefixNew(prefix string, models ...interface{}) {
	for _, model := range models {
		registerModel(prefix, model, true)
	}
}
...
// RegisterModelWithSuffix register models with a suffix
func RegisterModelWithSuffixNew(suffix string, models ...interface{}) {
	for _, model := range models {
		registerModel(suffix, model, false)
	}
}
